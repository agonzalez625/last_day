...
class PostingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create posting" do
    assert_difference('Posting.count') do
      post postings_url, params: { posting: { location: @posting.location, message: @posting.message, subject: @posting.subject } }
    end
  ...
  test "should update posting" do
    patch posting_url(@posting), params: { posting: { location: @posting.location, message: @posting.message, subject: @posting.subject } }
